...
class Artist(models.Model):
    ...
    artist_name = models.CharField(max_length=100, default=_("Unknown Artist"), null=False, blank=False)
    artist_title = models.CharField(max_length=100, default=_("Unknown"), null=False, blank=False)
    artist_cover = models.ImageField(upload_to=Artists_Profile_Images, validators=[validators.validate_image_extension], height_field=None, width_field=None, null=False, blank=False)
...
class Track(models.Model):
    ...
    track_name = models.CharField(max_length=100, default='Unknown Track', null=False, blank=False)
