...
from player.players import play_single_episode, play_season_episodes, play_playlist_episodes, play_favourite_episodes

schema_view = get_schema_view(
   openapi.Info(
      title="Controller Service API",
      default_version='v1',
      description="Controller Service API description",
...
urlpatterns = [
    ...
    path('favourite_player/', play_favourite_episodes, name='favourite_player'),
